...
df = pd.read_csv("/Users/jpalcantara/Downloads/votacao_secao_2006_BR/votacao_secao_2006_BR.txt", encoding = 'latin1', sep = ";", names = header1)
...
ds = pd.read_csv("/Users/jpalcantara/Downloads/detalhe_votacao_munzona_2006/detalhe_votacao_munzona_2006_BR.txt", encoding = 'latin1', sep = ";", names = header2, index_col = False)
...
ds_pres_1T.to_csv("/Users/jpalcantara/Desktop/2006_pres_1T.csv")
ds_pres_2T.to_csv("/Users/jpalcantara/Desktop/2006_pres_2T.csv")