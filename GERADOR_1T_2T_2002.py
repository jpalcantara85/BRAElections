...
dataset1 = pd.read_csv("/Users/jpalcantara/Desktop/Trade in Elections/Files/1T 2T 2002/Presidente VOTOS/votacao_candidato_munzona_2002_BR.txt", encoding = 'latin1', sep = ";", header = None)
...
dataset2 = pd.read_csv("/Users/jpalcantara/Desktop/Trade in Elections/Files/1T 2T 2002/Presidente APTOS/detalhe_votacao_secao_2002_BR.txt", encoding = 'latin1', sep = ";", header = None)
...
ds_pres_final1.to_csv("1T_pres_2002.csv")
ds_pres_final2.to_csv("2T_pres_2002.csv")

######

folder_1 = glob.glob("/Users/jpalcantara/Desktop/Trade in Elections/Files/1T 2T 2002/Candidatos VOTOS/" + "/*.txt")
list_1 = []
frame_1 = []
...
#datasetA = pd.read_csv("/Users/jpalcantara/Desktop/Trade in Elections/Files/1T 2T 2006/Candidatos VOTOS/votacao_partido_munzona_2006_AC.txt", encoding = 'latin1', sep = ";", header = None)
...
folder_2 = glob.glob("/Users/jpalcantara/Desktop/Trade in Elections/Files/1T 2T 2002/Candidatos APTOS/" + "/*.txt")
list_2 = []
frame_2 = []
...
ds_gov_2002 = x[x.CD_CARGO == 3]
ds_gov_2002 = ds_gov_2002.drop("CD_CARGO", 1)

ds_sen_2002 = x[x.CD_CARGO == 5]
ds_sen_2002 = ds_sen_2002.drop("CD_CARGO", 1)

ds_depfed_2002 = x[x.CD_CARGO == 6]
ds_depfed_2002 = ds_depfed_2002.drop("CD_CARGO", 1)

ds_depest_2002 = x[x.CD_CARGO == 7]
ds_depest_2002 = ds_depest_2002.drop("CD_CARGO", 1)

###

ds_gov_2002.to_csv("1T_gov_2002.csv")
ds_sen_2002.to_csv("1T_sen_2002.csv")
ds_depfed_2002.to_csv("1T_depest_2002.csv")
ds_depest_2002.to_csv("1T_depfed_2002.csv")

#####

folder_3 = glob.glob("/Users/jpalcantara/Desktop/Trade in Elections/Files/1T 2T 2002/Partidos/" + "/*.txt")
list_3 = []
...
ds_nomes_candidatos.to_csv("candidatos_2002.csv")