...
df = pd.read_csv("/Users/jpalcantara/Downloads/votacao_secao_2002_BR/votacao_secao_2002_BR.txt", encoding = 'latin1', sep = ";", names = header1)

df_1T = df[df["NUM_TURNO"] == 1]
df_2T = df[df["NUM_TURNO"] == 2]

df_pres_1T_votos = pd.pivot_table(df_1T,
                                  index      =   ["CD_MUNICIPIO", "NM_MUNICIPIO"], 
                                  values     =   ["QT_VOTOS"], 
                                  columns    =   ["NUM_VOTAVEL"],
                                  aggfunc    =   np.sum,
                                  fill_value =   0
...
ds = pd.read_csv("/Users/jpalcantara/Downloads/detalhe_votacao_munzona_2002/detalhe_votacao_munzona_2002_BR.txt", encoding = 'latin1', sep = ";", names = header2, index_col = False)
...
ds_pres_1T.to_csv("/Users/jpalcantara/Desktop/2002_pres_1T.csv")
ds_pres_2T.to_csv("/Users/jpalcantara/Desktop/2002_pres_2T.csv")